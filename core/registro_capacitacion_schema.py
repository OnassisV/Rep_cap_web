...
REGISTRO_CAPACITACION_SECCIONES: list[dict[str, Any]] = [
    {
        ...
        "campos": [
            ...
            _campo("pt_modalidades_json", "Modalidad y sesiones", "modalidad_multi", False, ["Presencial", "Virtual sincrónica", "Virtual asincrónica"], "Selecciona una o más modalidades e indica las sesiones o módulos de cada una.", "left"),
    ...
    # ── 5to pop-up: Plan de Trabajo ──
    {
        ...
        "campos": [
            ...
            _campo("pt_convocatoria_inicio", "Inicio de convocatoria", "date"),
            _campo("pt_convocatoria_fin", "Fin de convocatoria", "date"),
            _campo("pt_implementacion_inicio", "Inicio de implementacion", "date"),
            _campo("pt_implementacion_fin", "Fin de implementacion", "date"),
