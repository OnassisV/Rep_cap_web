...
REGISTRO_CAPACITACION_SECCIONES: list[dict[str, Any]] = [
    ...
    {
        "slug": "diagnostico-sustento",
        "titulo": "Diagnostico y sustento",
        "descripcion": "Fundamento tecnico, evidencia y alineamiento de la necesidad.",
        "campos": [
            _campo("diag_problema", "Problema o necesidad que atiende", "text_long", True),
            _campo("diag_brecha", "Brecha de capacidades identificada", "text_long", True),
            _campo(
                "diag_fuente",
            ...
            _campo("diag_fuente_det", "Nombre del documento o reporte fuente", "text_short"),
